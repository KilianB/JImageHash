...
class SingleImageMatcherTest {
	...
	static void loadImages() {
		try {
			...
			copyright = ImageIO.read(SingleImageMatcherTest.class.getClassLoader().getResourceAsStream("copyright.jpg"));
			highQuality = ImageIO
					.read(SingleImageMatcherTest.class.getClassLoader().getResourceAsStream("highQuality.jpg"));
			lowQuality = ImageIO.read(SingleImageMatcherTest.class.getClassLoader().getResourceAsStream("lowQuality.jpg"));
			thumbnail = ImageIO.read(SingleImageMatcherTest.class.getClassLoader().getResourceAsStream("thumbnail.jpg"));
		...
		void noAlgorithm() {
			...
			assertThrows(IllegalStateException.class,()->{matcher.checkSimilarity(dummyImage,dummyImage);});
		}
