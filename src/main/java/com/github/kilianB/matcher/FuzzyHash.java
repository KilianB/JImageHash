 ...
 * 
 * <p>
 * <b>Implnote:</b> Opposed to the original
 * {@link com.github.kilianB.matcher.Hash} equals and hashcode are not
 * overwritten to ensure correct functionality in hash collections after
 * factoring in mutable fields. To check if hashes are equals calculate the
 * distance between the hashes instead.
 * 
 * @author Kilian
 * @since 3.0.0
 */
...
//TODO document merge with fuzzy hash
	 ...
	 * 
	 * <p>
	 * Merging multiple fuzzy is a geometric averaging operation resulting in a hash
	 * with the lowest summed distance to it's members.
	 *
	 * <p>
	 * Opposed to {@link #merge(Hash)} this method does not perform any input
	 * validation. If incompatible hashes are added (especially hashes with
